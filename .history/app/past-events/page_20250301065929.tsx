      ...
      <div className="bg-sky-900 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="py-8 md:py-16">
            <h1 className="text-3xl md:text-5xl font-bold">{t.pastEvents.title}</h1>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-12">
          <section className="space-y-6">
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-center mt-4 text-muted-foreground">{t.pastEvents.videoCaption}</p>
            </div>
          </section>
          ...
          {events.map((event) => (
            <section key={event.year} className="space-y-6">
              <h2 className="text-2xl font-bold">
                {event.year === 2023 ? t.pastEvents.event2023 : t.pastEvents.event2014}
              </h2>
                    ...
                    {event.images.map((image, index) => (
                      <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                        <Dialog>
                          ...
                          <DialogContent>
                            <DialogHeader>
                              <DialogTitle className="sr-only">{event.year}年大会の写真</DialogTitle>
